    ...
    faqs: [
      {
        ...
        answer: 'All authorized dealers can be found on our website by going to www.hustlerturf.com. Use the |SPLIT| button in the upper right hand corner of the page. The locator will help you find local dealers in your area.',
        link: 'http://www.hustlerturf.com/find-a-retailer',
      },
      {
        question: 'I need to purchase parts for my mower. Can I contact Hustler Turf for parts?',
        answer: 'Hustler Turf does not sell parts to the public. All part sales are done through our authorized dealerships. A list of all authorized dealers can be found on our website by going to www.hustlerturf.com. Use the |SPLIT| button in the upper right hand corner of the page, it will help you to find local dealers in your area.',
        link: 'http://www.hustlerturf.com/find-a-retailer',
      },
      {
        question: 'I need an Operator’s Manual or a General Service Manual for my mower.',
        answer: 'All of our |SPLIT| are available for free on our website under the support tab. You can find the manual for your mower by clicking the appropriate section and then search by model number. If your manual is not on-line, please contact your dealer.',
        link: 'http://www.hustlerturf.com/support/manuals',
      },
      {
      ...
      {
        question: 'My mower does not steer straight.',
